...
const NAV_ITEMS: {
  ...
  { label: "Tableau de bord", page: "artisan-dashboard", icon: <LayoutDashboard size={18} /> },
  { label: "Mes produits", page: "artisan-products", icon: <Package size={18} /> },
  { label: "Commandes", page: "artisan-orders", icon: <ShoppingBag size={18} /> },
  { label: "Statistiques", page: "artisan-stats", icon: <BarChart3 size={18} /> },
  { label: "Mon profil", page: "artisan-profile", icon: <User size={18} /> },
];
    ...
    <div className="flex min-h-screen bg-[var(--bg-cream)]">
      ...
      <aside className="hidden lg:flex flex-col w-60 bg-[var(--bg-card)] border-r border-[var(--border)] p-4 gap-1 sticky top-0 h-screen">
        <div className="mb-6 px-2">
          ...
          <p className="text-xs text-[var(--text-3)] mt-0.5">Espace Artisan</p>
        </div>
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        <header className="lg:hidden flex items-center justify-between px-4 py-3 bg-[var(--bg-card)] border-b border-[var(--border)] sticky top-0 z-40">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-[var(--text-3)]">Artisan</span>
          </div>
          <button

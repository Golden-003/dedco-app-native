...
export const MOCK_EN_COURS: MesProjetsItem[] = [
  // 1. Modification de matériau à valider (priorité 2)
  {
    ...
    image: "https://images.unsplash.com/photo-1617364852223-75f57e78dc96?auto=format&fit=crop&w=800&q=85",
    ...
    partnerAvatar: "https://images.unsplash.com/photo-1509099863731-ef4bff19e808?auto=format&fit=crop&w=400&q=85",
    partnerType: "artisan",
    amount: 245000,
  ...
  // 2. Livraison à confirmer (priorité 3)
  {
    ...
    partnerAvatar: "https://images.unsplash.com/photo-1507152927179-bc4ebfef7103?auto=format&fit=crop&w=400&q=85",
    partnerType: "artisan",
    amount: 68000,
    securedAmount: 68000,
  ...
  // 3. Projet artisan en fabrication (priorité 7)
  {
    ...
    image: "https://images.unsplash.com/photo-1510828561531-05a3388f6d3d?auto=format&fit=crop&w=800&q=85",
    status: "IN_PRODUCTION",
    statusLabel: "En fabrication",
    statusColor: "var(--amber-dark)",
    statusBgColor: "var(--amber-pale)",
    partnerName: "Brice Gogan",
    partnerAvatar: "https://images.unsplash.com/photo-1620932934088-fbdb2920e484?auto=format&fit=crop&w=400&q=85",
    partnerType: "artisan",
    amount: 95000,
    securedAmount: 47500,
  ...
  // 4. Projet artisan avec mise à jour récente (priorité 7)
  {
    ...
    image: "https://images.unsplash.com/photo-1566921895456-1cee6-8cee6f646-1cee6-8cee6f646-1cee6-8cee6f646?auto=format&fit=crop&w=800&q=85",
    status: "IN_PRODUCTION",
    statusLabel: "En fabrication",
    statusColor: "var(--amber-dark)",
    statusBgColor: "var(--amber-pale)",
  ...
  // 6. Livrable designer disponible (priorité 5)
  {
    ...
    partnerAvatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=400&q=85",
    partnerType: "designer",
    amount: 250000,
...
export const MOCK_BRIEF_WITH_PROPOSALS: ArtisanBriefWithProposals = {
  ...
  briefImage: "https://images.unsplash.com/photo-1558997519-83ea9252edf8?auto=format&fit=crop&w=800&q=85",
  category: "Rangements",
  zone: "Cotonou",
  budgetMin: 150000,
  budgetMax: 300000,
...
export const MOCK_PRESTATIONS_DESIGNER: DesignerPrestation[] = [
  {
    ...
    designerAvatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=400&q=85",
...
export const MOCK_TERMINES: MesProjetsItem[] = [
  // Projet artisan livré et clôturé
  {
    ...
    partnerAvatar: "https://images.unsplash.com/photo-1614023342667-6f060e9d1e04?auto=format&fit=crop&w=400&q=85",
    partnerType: "artisan",
    amount: 420000,
...
export const MOCK_RECLAMATIONS: Reclamation[] = [
  {
    ...
    projectImage: "https://images.unsplash.com/photo-1532372576444-dda954194ad0?auto=format&fit=crop&w=800&q=85",
  ...
  },
  {
    ...
    projectImage: "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=800&q=85",
    partnerName: "Fatou Loko",
